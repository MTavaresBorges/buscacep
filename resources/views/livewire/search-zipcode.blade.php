<div>
    <x-notifications />
    <form class="p-8 bg-gray-200 flex flex-col w-1/2 mx-auto gap-2">
        <h1>Buscador de CEP</h1>
        <div class="flex flex-col w-1/2">
            <x-input wire:model.lazy="data.zipcode" label="CEP" placeholder="Informe o seu CEP" />
        </div>
        <div class="flex flex-col w-1/2">
            <x-input wire:model.lazy="data.street" label="Rua" placeholder="Informe a sua Rua" />
        </div>
        <div class="flex flex-col w-1/2">
            <x-input wire:model.lazy="data.neighborhood" label="Bairro" placeholder="Informe o seu Bairro" />
        </div>
        <div class="flex flex-col w-1/2">
            <x-input wire:model.lazy="data.city" label="Cidade" placeholder="Informe a sua Cidade" />
        </div>
        <div class="flex flex-col w-1/2">
            <x-input wire:model.lazy="data.state" label="Estado/UF" placeholder="Informe o seu Estado/UF" />
        </div>
